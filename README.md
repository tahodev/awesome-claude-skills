...
**Source:** [tahodev/baodao-skill](https://github.com/tahodev/baodao-skill/tree/main/invoice-winning-numbers)
**Description:** Checks Taiwan uniform-invoice winning numbers - latest draw, batch checking, cloud-invoice exclusive prizes from the official PDF list.
**Use Case:** When users want to match Taiwan uniform invoice receipts against the latest winning numbers
**Stars:** ⭐⭐⭐⭐
...
| [tahodev/baodao-skill](https://github.com/tahodev/baodao-skill) | 5 | @tahodev | Taiwan daily life on official open data: invoice prize checks, YouBike availability, garbage truck schedules, CWA weather, disaster alerts |
